...
> **Version: v1.1**
> **Created: 2026-06-28**
> **Updated: 2026-06-28** (TTS upgraded to multi-provider)
...
| **v1.1** | 2026-06-28 | TTS upgraded: multi-provider fallback chain (Google TTS → StreamElements Amazon Polly → Web Speech API). Replaces single Web Speech API approach for better voice quality. |
